...
import com.example.android.uamp.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_SEARCH
...
object QueueHelper {
    ...
    fun getPlayingQueueFromSearch(query: String,
        ...
        var result: List<MediaMetadataCompat>? = null
     ...
     */
    fun isQueueItemPlaying(context: Activity,
